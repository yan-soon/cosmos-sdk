...
var (
	...
	pattern_Query_LiquidityProviderRewards_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "distribution", "v1beta1", "liquidity_provider_rewards"}, "", runtime.AssumeColonVerbOpt(true)))
)
